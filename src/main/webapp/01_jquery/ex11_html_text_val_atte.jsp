...
// val()  : input type의 value 설명 및 반환
// attr() :태그 속성 설정 및 반환
$(document).ready(function(){
	$("#btn1").on("click", function() {
		$("#p1").text("<h2> Hello jQuery</h>");
	});
	$("#btn2").on("click", function() {
		$("#p1").html("<h2> Hello jQuery</h>");
	});
	$("#btn3").on("click", function() {
		$("#p1").append("<h2 style='color:red'> Hello jQuery</h>");
	});
...
<body>
	...
	<p><a href="https://www.w3school.com" id="w3">W3Schools.com</a></p>
	<hr>
