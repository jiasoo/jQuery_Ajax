...
$(document).ready(function(){
	var list = $("#banner");
	var show_num = 3 ;                   // 화면의 노출 되는 그림의 수
...
<body>
	...
	<div id="banner_wrap">
		<div id="frame">
			<ul id="banner">
				<li><a href="#"><img src="../images/b8eadb02901eb442.png"></a> </li>
				<li><a href="#"><img src="../images/8ddb12006cdac012.png"></a> </li>
				<li><a href="#"><img src="../images/9e61e32443f19352.png"></a> </li>
				<li><a href="#"><img src="../images/7fbe62205f31f117.png"></a> </li>
				<li><a href="#"><img src="../images/soo.PNG"></a> </li>
			</ul>
		</div>
		<p id="img">
