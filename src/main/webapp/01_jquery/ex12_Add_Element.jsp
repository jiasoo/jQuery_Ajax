...
$(document).ready(function(){
	...
	$("#btn2").on("click", function() {
		$("ol").append("<li>글자 뒤에 추가하기</il>");
	});
	$("#btn3").on("click", function() {
		$("p").prepend("<b>글자 뒤에 추가하기</b>");
	});
	$("#btn4").on("click", function() {
		$("ol").prepend("<li>글자 뒤에 추가하기</il>");
	});
	$("#btn5").on("click", function() {
		$("p").before("<b>글자 뒤에 추가하기</b>");
	});
	$("#btn6").on("click", function() {
		$("ol").before("<li>글자 뒤에 추가하기</il>");
	});
});
</script>
</head>
